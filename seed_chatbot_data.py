...
RFQS_TRIMMING = [
    dict(
        ...
        # Other info
        oi_frame_refurbishment=False, oi_frame_refurbishment_note='N/A',
        oi_set_of_electric_wires=True, oi_set_of_electric_wires_note='Standard harness',
        oi_others_applies=True, oi_others='Pneumatic blow-off included',
        oi_delivery_date_imex_applies=True, oi_delivery_date_imex=date(2026, 8, 15),
        oi_ejector_fixed_applies=True, oi_ejector_fixed_note='Spring return ejectors',
        oi_ejector_system_fixed_side='Spring return ejectors',
        # Part geometry
        part_name='Engine Mount Trim', part_number='EMT-101',
        part_dimension='385 x 210 x 95', min_wall_thickness_mm=2.8,
        max_wall_thickness_mm=12.0, projected_area_cm2=480.0,
        surface_cm2=1250.0, volume_cm3=820.0, gross_weight_g=2214.0,
        # Tool spec
    ...
    dict(
        ...
        oi_frame_refurbishment=True, oi_frame_refurbishment_note='Full frame refurbishment',
        oi_set_of_electric_wires=True, oi_set_of_electric_wires_note='Complete set',
        oi_others_applies=False, oi_others='N/A',
        oi_delivery_date_imex_applies=True, oi_delivery_date_imex=date(2026, 10, 1),
        oi_ejector_fixed_applies=True, oi_ejector_fixed_note='Air ejection',
        oi_ejector_system_fixed_side='Air ejection',
        part_name='Rear Differential Housing Trim', part_number='RDH-102',
        part_dimension='420 x 280 x 185', min_wall_thickness_mm=3.2,
    ...
    dict(
        ...
        oi_frame_refurbishment=False, oi_frame_refurbishment_note='N/A',
        oi_set_of_electric_wires=True, oi_set_of_electric_wires_note='Complete set',
        oi_others_applies=True, oi_others='Scrap chute included',
        oi_delivery_date_imex_applies=True, oi_delivery_date_imex=date(2026, 10, 20),
        oi_ejector_fixed_applies=True, oi_ejector_fixed_note='Hydraulic ejectors',
        oi_ejector_system_fixed_side='Hydraulic ejectors',
        part_name='Suspension Bracket Trim', part_number='SBT-103',
        part_dimension='520 x 310 x 140', min_wall_thickness_mm=3.5,
        max_wall_thickness_mm=18.0, projected_area_cm2=920.0,
        surface_cm2=2800.0, volume_cm3=1650.0, gross_weight_g=4455.0,
