...
class RFQ_Mold(models.Model):
    ...
    # Info general
    status       = models.CharField (max_length=10, default= Roles.INDUSTRIALIZACION, choices=Roles.choices)## duda si puede ser nulo
    ...
    PT    = models.CharField(max_length=100, default="")
    PNUM  = models.CharField(max_length=100, default="")
    PRLF  = models.FloatField(default=0.0)
    TT    = models.CharField(max_length=100, default="")
    DTQ   = models.DateField(blank=True, null=True)
    ELAB  = models.CharField(max_length=255, default="")

    # DCM
    SMACH          = models.CharField(max_length=100, blank=True , default="")
    No_CAV         = models.CharField(max_length=100, blank=True, default=0.0)
    No_ofHS        = models.FloatField (max_length=100, blank=True, default=0.0)
    No_ofMS        = models.FloatField(max_length=100, blank=True, default=0.0)
    ThirdPSupp     = models.CharField(max_length=100, blank=True, default=0.0)
    ...
    # DATA INFORMATION REQUIRED IN THE PRICE OF THE DIE campos bit + nota
    ...
    # Tool Specification
    number_of_gates_per_part   = models.CharField(max_length=100, null=True, blank=True)
    number_of_parts_per_stroke = models.CharField(max_length=100, null=True, blank=True)
    number_of_tools            = models.CharField(max_length=100, null=True, blank=True)
